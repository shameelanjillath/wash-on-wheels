...
const Footer = () => {
  return (
    <footer className="bg-carwash-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand column */}
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <CarFront className="h-6 w-6 text-carwash-accent" />
              <span className="text-xl font-display font-semibold">SplashWash</span>
            </div>
            <p className="text-gray-300 text-sm max-w-xs">
              The premier platform for finding and booking top-rated car wash services near you.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/vendors" className="text-gray-300 hover:text-white transition-colors text-sm">Find Locations</Link></li>
              <li><Link to="/booking" className="text-gray-300 hover:text-white transition-colors text-sm">Book a Wash</Link></li>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 SplashWash. All rights reserved.</p>
